...
import { createRequestEndAction, createRequestErrorMessageAction, createRequestStartAction, createRequestSuccessAction } from 'src/redux/request/requestAction';
...
export class RequestForgotPassword {
    ...
    forgotPasswrod(email: string) {
        ...
        SSOApi.forgotPassword(email).then((response) => {
