...
export enum UserAction {
    ...
    // BOOKING
    BOOKING_SELECT_WORK_LAYOUT = 'BOOKING_SELECT_WORK_LAYOUT',
    BOOKING_SELECT_BOOKING_HISTORY = 'BOOKING_SELECT_BOOKING_HISTORY',
    BOOKING_SELECT_BOOKING_TIME = 'BOOKING_SELECT_BOOKING_TIME',
    BOOKING_SELECT_PLACE = 'BOOKING_SELECT_PLACE',
    BOOKING_BOOK_PLACE = 'BOOKING_BOOK_PLACE',
    BOOKING_CANCEL_BOOKING = 'BOOKING_CANCEL_BOOKING',
